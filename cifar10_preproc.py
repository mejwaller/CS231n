...
class PreProcCifar10:
    ...
    def preProcess(self):
       ...
       3695, 4393, 2996, 2472, 1491]
        ...
        print self.mean_image[:10] # print a few of the elements
        #plt.figure(figsize=(4,4))
        #plt.imshow(self.mean_image.reshape((32,32,3)).astype('uint8')) # visualize the mean image
        #plt.show()
        ...
        self.X_dev -= self.mean_image
        self.fixedX_dev -= self.mean_image
